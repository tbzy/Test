!------------------------------------------------------------------------
! lib_bessel_misc.F90  (Last updated: 2014-11-09)
!
...
!////////////////////////////////////////////////////////////////////////
module Jin_SPHJ_mod   !! not recommended for general use

    !! Spherical Bessel routine (MSPHJ.for) from J. Jin's mathbook.
    !! http://jin.ece.illinois.edu/routines/routines.html

    !! NOTE:
    !! * SPHJ() returns NaN for x ~ 0 and
    !!   very large values of x (e.g., x = 4000).

contains


!========================================================================
_sub_ spherical_bessel_jin ( n, x, jn )
...
!! wrapper for SPHJ().
    ...
    _int_  :: nn
    _dble_ :: jn_all( 0 : n ), jn_deriv_all( 0 : n )
    !.........................................................

    call SPHJ ( n, x, nn, jn_all, jn_deriv_all )
...
!>>>
           ...
           NN = int( N1-(N1-N0)/(1.0D0-F0/F1) )  !! to avoid warning
!<<<
           F=ENVJ(NN,A0)-MP
